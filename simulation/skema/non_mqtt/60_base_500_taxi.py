...
def generate_simulation_visualizations():
    ...
    if not os.path.exists('60_base_500_taxi'):
        os.makedirs('60_base_500_taxi')
    ...
    plt.tight_layout()
    plt.savefig('60_base_500_taxi/hourly_order_statistics.png', dpi=300, bbox_inches='tight', 
    ...
    plt.tight_layout()
    plt.savefig('60_base_500_taxi/base_order_performance.png', dpi=300, bbox_inches='tight', 
                facecolor='white', edgecolor='none')
    plt.close()
    ...
    plt.ylim(0, 110)
    plt.tight_layout()
    plt.savefig('60_base_500_taxi/service_rate_by_base.png', dpi=300, bbox_inches='tight', 
                facecolor='white', edgecolor='none')
    plt.close()
