...
def generate_simulation_visualizations():
    ...
    if not os.path.exists('20_base_1000_taxi'):
        os.makedirs('20_base_1000_taxi')
    ...
    plt.tight_layout()
    plt.savefig('20_base_1000_taxi/hourly_order_statistics.png', dpi=300, bbox_inches='tight', 
    ...
    plt.tight_layout()
    plt.savefig('20_base_1000_taxi/base_order_performance.png', dpi=300, bbox_inches='tight', 
                facecolor='white', edgecolor='none')
    plt.close()
    ...
    plt.ylim(0, 110)
    plt.tight_layout()
    plt.savefig('20_base_1000_taxi/service_rate_by_base.png', dpi=300, bbox_inches='tight', 
                facecolor='white', edgecolor='none')
    plt.close()
