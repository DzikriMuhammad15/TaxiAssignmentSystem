...
def generate_simulation_visualizations():
    ...
    if not os.path.exists('20_base_10000_taxi_result'):
        os.makedirs('20_base_10000_taxi_result')
    ...
    plt.tight_layout()
    plt.savefig('20_base_10000_taxi_result/hourly_order_statistics.png', dpi=300, bbox_inches='tight', 
    ...
    plt.tight_layout()
    plt.savefig('20_base_10000_taxi_result/base_order_performance.png', dpi=300, bbox_inches='tight', 
                facecolor='white', edgecolor='none')
    plt.close()
    ...
    plt.ylim(0, 110)
    plt.tight_layout()
    plt.savefig('20_base_10000_taxi_result/service_rate_by_base.png', dpi=300, bbox_inches='tight', 
                facecolor='white', edgecolor='none')
    plt.close()
